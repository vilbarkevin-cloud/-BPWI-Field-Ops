...
export function TopBar({
  ...
  return (
    <header className="border-b border-outline-variant w-full top-0 sticky z-40 flex justify-between items-center px-4 md:px-6 h-14 shrink-0 bg-surface/70 backdrop-blur-md">
      <div className="flex items-center gap-3">
        ...
        <div className="flex items-center gap-2 md:hidden mr-4">
          ...
          <div className="flex flex-col">
            <span className="text-lg font-bold text-[#1F4E5A] leading-none">
              BPWI
            </span>
            <span className="text-xs font-medium text-[#6495A3] leading-none mt-0.5">
              Field Ops
            </span>
          </div>
        </div>
